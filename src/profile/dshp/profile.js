/** [ThunderForge] Vendored from dshp (asdf17128/dshp, MIT) src/profile.js — 未修改实现。上游许可证见 LICENSES/。 */
/**
 * Reading and writing DeepSeek Harness profiles.
 *
...
/** Mirrors dsh's own `resolveDshHome`. */
